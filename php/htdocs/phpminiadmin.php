...
*/
 ...
 $ACCESS_PWD='10caratteri'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access
 ...
 'host'=>"sql.simonecelia.it",#optional
 'port'=>"21",#optional
...
//constants
 $VERSION='1.9.150108';
 $MAX_ROWS_PER_PAGE=500; #max number of rows in select per one page
