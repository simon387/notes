...
Func Main()
    ...
    Local $Server = "antonella.boing-irc.it"     ; IRC Server
    Local $Port = 6667                      ; IRC Server Port
	Local $Pass = ""                        ; IRC Server Password

	;User Specific Connection Variables
    Local $Nick = "uykki"                  ; Nick Name to Use
    Local $Mode = 0                         ; User Mode to Use
    Local $RealName = "uykki"              ; Real Name to Use

	;Channel Variables
    Local $Channels = "#BOiNG" ; Channels to Join
;~     Local $Keys = "key1,key2"               ; Channel Passwords

    TCPStartup()
    Local $Sock = _IRCConnect($Server, $Port, $Nick, $Mode, $RealName); Connects to IRC. Sends Password, if any. Declares User Identity.
    If @error Then
